...
const KIND_THEME: Record<ActivityKind, KindTheme> = {
  message: { icon: MessageSquare, badge: 'bg-chart-2/10 text-chart-2' },
  contact: { icon: UserPlus, badge: 'bg-primary/10 text-primary' },
  deal: { icon: Briefcase, badge: 'bg-primary/10 text-primary' },
  broadcast: { icon: Radio, badge: 'bg-chart-4/10 text-chart-4' },
  automation: { icon: Zap, badge: 'bg-chart-3/10 text-chart-3' },
}
